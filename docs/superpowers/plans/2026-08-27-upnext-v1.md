...
export function SessionBoard({ state, players, undoLabel, onUndo, onFinish, onWin, onCloseCourt, onReopenCourt, onToggleSit, onToggleCheck }: {
  ...
  return (
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: 'var(--space-4)', padding: 'var(--space-4)', paddingBottom: undoLabel ? 'calc(var(--tap-primary) + var(--space-5))' : undefined, alignItems: 'start' }}>
