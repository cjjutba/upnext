 ...
 */
export function PlayerPicker({ name, context, candidates, sitting, onSwap, onSit, onRemove, onClose }: {
  name: string;
  ...
  return (
    <div
      ...
      <div
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-2)', padding: '12px var(--space-4)', borderTop: '1px solid var(--border)' }}>
