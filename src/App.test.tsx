...
describe('App: courtside calls, standings, and the mute switch', () => {
  ...
  it('hand-composes a lineup: substitute a waiting player onto the court', async () => {
    ...
    // staged only: Choose players is the sole lineup editor now that the live pencil is gone
    await click(btn('Choose players on court 1'));
    ...
    expect(said()).toEqual([]); // a staged re-lineup is as silent as the original stage
